...
namespace GeoserverManager.Rest.Client.Spike
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            //var response = restService.Get(new ServiceRequest("workspaces/webgis-dev/datastores/networkTopologyDev/featuretypes/live_cell_size_geom_tiny"));
            //var response = restService.Get(new ServiceRequest("workspaces"));
